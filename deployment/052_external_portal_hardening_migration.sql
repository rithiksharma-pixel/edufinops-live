...
comment on view v_lender_deal_list is
  'Lender pipeline list: student + stage for deals shared with the caller''s own bank. SECURITY DEFINER + security_barrier by design — see 052 header. Columns are a subset of get_lead_profile_for_lender().';
